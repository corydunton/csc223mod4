package edu.vwcc.worddata;

/**
 * The WordDataSummary program analyzes a given text to provide insights about the words contained within.
 * The program should be case-insensitive and consider only alphabetic characters.
 * 
 * You must implement the following methods:
 * - findMostPopularWord: Returns the most popular word in the text.
 * - countOccurrences: Returns the count of how many times the most popular word appears.
 * - countRepeatedWords: Returns the count of total words that repeat more than once.
 * 
 * Feel free to add whatever other fields and methods you find helpful!
 *
 * Run the associated JUnit tests to ensure your solution works.
 * Optionally, you can also use the main method provided below for your own testing.
 */
