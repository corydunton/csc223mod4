 ...
 *
 * Instructions:
 * 1. Implement the calculateChange method.
 * 2. Ensure that you use the fewest number of coins.
 * 3. The order of coins in the returned array should be [# of quarters, # of dimes, # of nickels, # of pennies].
 * 4. Test your method with the provided JUnit5 tests.
 */
